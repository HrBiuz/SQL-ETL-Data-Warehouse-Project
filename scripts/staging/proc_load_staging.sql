/*
===============================================================================
Stored Procedure: Load staging Layer (landing -> staging)
===============================================================================
Script Purpose:
    Moves and cleans data from Landing to staging tables.
    
Actions Performed:
    - Clears existing staging table data
    - Copies cleaned and organized data from Landing tables
